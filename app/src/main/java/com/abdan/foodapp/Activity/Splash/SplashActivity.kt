package com.abdan.foodapp.Activity.Splash
...
import com.abdan.foodapp.Activity.BaseActivity
import com.abdan.foodapp.Activity.Dashboard.MainActivity
...
class SplashActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SplashScreen(onGetStarterClick = {
...
@Composable
@Preview
fun SplashScreen(onGetStarterClick:()->Unit={}) {
    Column(modifier = Modifier
        ...
        val styledText= buildAnnotatedString {
            ...
            append("experience Food perfection delived")
        }
        ...
        GetStartedButton(onClick =onGetStarterClick,
            modifier = Modifier
                .padding(top=16.dp)
        )
